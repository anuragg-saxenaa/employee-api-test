...
/**
 * A skill or qualification associated to an employee
 */
@ApiModel(description = "A skill or qualification associated to an employee")
...
public class Skill {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Hoyer lift", value = "")
