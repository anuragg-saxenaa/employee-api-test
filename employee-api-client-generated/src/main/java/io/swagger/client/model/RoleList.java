 ...
 */
@ApiModel(description = "Paginated list of roles")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2022-06-01T22:10:48.279Z")
public class RoleList extends PaginatedList {
  @SerializedName("items")
  private List<Object> items = null;

  public RoleList items(List<Object> items) {
    this.items = items;
    return this;
  }

  public RoleList addItemsItem(Object itemsItem) {
    if (this.items == null) {
